...
BackgroundScene = (function(_super) {
  ...
  function BackgroundScene(parent) {
    ...
    this.sprites = [new BackgroundSprite, new ForegroundSprite, new BirdSprite];
  }
...
(function (process,global,Buffer,__argument0,__argument1,__argument2,__argument3,__filename,__dirname){
var BackgroundSprite, Sprite, Vector, _ref;

_ref = require('../lib/instant-rocket-fuel/src/irf'), Sprite = _ref.Sprite, Vector = _ref.Vector;
...
BackgroundSprite = (function() {
  function BackgroundSprite() {
    ...
    this.coords = new Vector(Math.floor(this.width / 2), Math.floor(this.height / 2));
    this.speed = new Vector(-0.05, 0.0);
  }

  BackgroundSprite.prototype.update = function(delta) {
    if (this.coords.x <= 0) {
      this.coords.x = Math.floor(this.width / 2);
    }
...
(function (process,global,Buffer,__argument0,__argument1,__argument2,__argument3,__filename,__dirname){
var BirdSprite, Sprite, Vector, _ref;
...
(function (process,global,Buffer,__argument0,__argument1,__argument2,__argument3,__filename,__dirname){
var ForegroundSprite, Sprite, Vector, _ref;
...
ForegroundSprite = (function() {
  function ForegroundSprite() {
    ...
    this.coords = new Vector(Math.floor(this.width / 2), 456);
...
(function (process,global,Buffer,__argument0,__argument1,__argument2,__argument3,__filename,__dirname){
var EventManager, Game, SceneManager, _ref,
  __hasProp = {}.hasOwnProperty,
  __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };

_ref = require('../lib/instant-rocket-fuel/src/irf'), Game = _ref.Game, SceneManager = _ref.SceneManager, EventManager = _ref.EventManager;
