...
BoundingBox = (function() {
  ...
  BoundingBox.prototype.contains = function(otherBB) {
    if (otherBB == null) {
      return false;
    }
    if (!this.intersect(otherBB)) {
      return false;
    }
    if (otherBB.dim.x > this.dim.x || otherBB.y > this.dim.x) {
      return false;
    }
  };
...
(function (process,global,Buffer,__argument0,__argument1,__argument2,__argument3,__filename,__dirname){
var BackgroundScene, BackgroundSprite, BirdSprite, Camera, ForegroundSprite, Map, Scene, _ref,
  __hasProp = {}.hasOwnProperty,
  __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };

_ref = require('../lib/instant-rocket-fuel/src/irf'), Scene = _ref.Scene, Map = _ref.Map, Camera = _ref.Camera;
...
BackgroundScene = (function(_super) {
  ...
  function BackgroundScene(parent) {
    ...
    this.sprites = [new BackgroundSprite(this.parent.eventManager, this.parent.keyboard), new ForegroundSprite(this.parent.eventManager, this.parent.keyboard), new BirdSprite(this.parent.eventManager, this.parent.keyboard)];
  }

  BackgroundScene.prototype.update = function(delta) {
    var sprite, _i, _len, _ref1, _results;
    if (this.sprites[1].hitbox.intersect(this.sprites[2].hitbox)) {
      this.sprites[2].setBlocked(true);
    } else {
      this.sprites[2].setBlocked(false);
    }
    _ref1 = this.sprites;
    _results = [];
    for (_i = 0, _len = _ref1.length; _i < _len; _i++) {
      sprite = _ref1[_i];
      _results.push(sprite.update(delta));
    }
    return _results;
  };
  ...
  BackgroundScene.prototype.render = function(ctx) {
    ...
    for (_i = 0, _len = _ref1.length; _i < _len; _i++) {
      sprite = _ref1[_i];
      _results.push(sprite.render(ctx));
    }
    return _results;
  };
...
},{"../lib/instant-rocket-fuel/src/irf":6,"./background-sprite":28,"./bird-sprite":29,"./foreground-sprite":30,"1YiZ5S":25,"buffer":22}],28:[function(require,module,exports){
(function (process,global,Buffer,__argument0,__argument1,__argument2,__argument3,__filename,__dirname){
...
BirdSprite = (function() {
  ...
  BirdSprite.prototype.setBlocked = function(blocked) {
    this.isBlocked = blocked;
    if (this.isBlocked) {
      return this.speed.set(0, 0);
    }
  };
...
},{"../node_modules/jquery/dist/jquery.js":26,"./background-scene":27,"./game":31,"1YiZ5S":25,"buffer":22}]},{},[32])