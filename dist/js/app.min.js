...
Sprite = (function() {
  ...
  Sprite.prototype.addImage = function(name, index) {
    return this.texture.onload = (function(_this) {
      return function() {
...
(function (process,global,Buffer,__argument0,__argument1,__argument2,__argument3,__filename,__dirname){
var BackgroundScene, Camera, Map, Scene, Sprite, Vector, _ref,
  __hasProp = {}.hasOwnProperty,
  __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };

_ref = require('../lib/instant-rocket-fuel/src/irf'), Scene = _ref.Scene, Sprite = _ref.Sprite, Map = _ref.Map, Camera = _ref.Camera, Vector = _ref.Vector;

BackgroundScene = (function(_super) {
  __extends(BackgroundScene, _super);

  function BackgroundScene(parent) {
    var backgroundSprite, foregroundSprite;
    this.parent = parent;
    BackgroundScene.__super__.constructor.call(this);
    this.width = 288;
    this.height = 512;
    ...
    this.foregroundCamera = new Camera({
      "projection": "normal",
      "vpWidth": 288,
      "vpHeight": 112
    });
    this.backgroundCamera.coor = new Vector(this.width, Math.floor(this.height / 2));
    this.foregroundCamera.coor = new Vector(Math.floor(this.width / 2), -344);
  }

  BackgroundScene.prototype.update = function(delta) {
    if (this.backgroundCamera.coor.x === 2 * this.width) {
      this.backgroundCamera.coor.x = this.width;
    }
    if (this.foregroundCamera.coor.x === 1.5 * this.width) {
      this.foregroundCamera.coor.x = this.width;
    }
    if (this.isScrolling) {
      this.backgroundCamera.coor.x += this.scrollSpeed;
      return this.foregroundCamera.coor.x += this.scrollSpeed * 4;
    }
  };

  BackgroundScene.prototype.render = function(ctx) {
    this.backgroundCamera.apply(ctx, (function(_this) {
      return function() {
        return _this.background.render(ctx, _this.backgroundCamera);
      };
    })(this));
    return this.foregroundCamera.apply(ctx, (function(_this) {
      return function() {
        return _this.foreground.render(ctx, _this.foregroundCamera);
      };
    })(this));
  };
...
},{"../lib/instant-rocket-fuel/src/irf":6,"1YiZ5S":25,"buffer":22}],28:[function(require,module,exports){
(function (process,global,Buffer,__argument0,__argument1,__argument2,__argument3,__filename,__dirname){
...
jQuery(function() {
  ...
  return game.eventManager.on("map.finishedLoading", function() {
    return game.start();
  });
});
...
},{"../node_modules/jquery/dist/jquery.js":26,"./background-scene":27,"./game":28,"1YiZ5S":25,"buffer":22}]},{},[29])